                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="post" method="POST">
                                        <button type="button" class="btn btn-primary btn-sm btn-disposisi"
                                            data-toggle="modal" data-target="#modal-default"
                                            data-nomor="{{ $d->nomor_surat }}" data-id="{{ $d->id }}">
                                            <i class="fa fa-paper-plane"></i>
                                        </button>
                                        @csrf
                                        <a href='{{ route('editsurat', $d->id) }}' class="btn btn-success btn-sm"><i
                                                class="fa fa-pen"></i></a>
                                    </form>
                                    <form id="delete-form-{{ $d->id }}" 
                                        action="{{ route('hapussurat', $d->id) }}" 
                                        method="POST"
                        ...
                        <form action="{{ route('simpandisposisi') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nomor_surat_modal" placeholder=""
                                        readonly>
                                </div>
                                <!-- sementara -->
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="dari_user_id"
                                        value="{{ Auth::user()->id }}" placeholder="{{ Auth::user()->name }}" readonly>
                                </div>
                                <!-- end sementara -->
                                <div class="form-group">
