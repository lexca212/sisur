            ...
            <form action="{{ route('settings.store') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <small class="text-muted italic">*Pastikan ID sesuai dengan ID bot yang Anda gunakan.</small>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content text-dark">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus Chat ID <strong>{{ $setting->chat_id }}</strong>?</p>
            </div>
